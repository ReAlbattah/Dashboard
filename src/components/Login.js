...
const Login = () => {
  ...
  // const {logincustomers, addIsLogged } = useContext(AuthContext);
  // const {loginsecurity, addIsLogged } = useContext(AuthContext);
  ...
  return (
    <HStack spacing="-20">
      ...
      <Flex
        ...
        justifyContent="center"
      >
        <Image src={CarParking} width="493px" height="700px"></Image>
      </Flex>
    </HStack>
  );
}
